...
// Method to count events by user
countEventsByUser(userId: number): Observable<number> {
  return this.http.get<number>(`${this.apiUrl}/events/countByUser/${userId}`, { headers: this.getAuthHeaders() });
}
